...
def cross_validation(model, num_of_fold, train_data, train_label):
    ...
    # it will divide the data set into 4 and use 1/4 of it for testing
...
print('reading data')
training_dataset_dir = 'C:/Users/Abhinav/Downloads/LicensePlateRecognition/train20X20'
...
filename = 'C:/Users/Abhinav/Downloads/LicensePlateRecognition/finalized_model.sav'
